...
/**
 * Represents a user entity in the system, mapped to the "User" table in the
 * database.
 *
 * <h3>Jakarta Bean ORM Mapping:</h3>
 * <ul>
 * <li><strong>@Entity</strong>: Marks this class as a JPA entity.</li>
 * <li><strong>@Table(name = "User")</strong>: Specifies the corresponding
 * database table.</li>
 ...
 *
 * <p>
 * This entity stores user-specific data such as UUID, email, password, name,
 * role, and
