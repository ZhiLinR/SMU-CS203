...
// playedPairs.add("player4-uuid-player2-uuid"); // Include both orders to
// handle symmetry
...
// verify(playerSorter, times(1)).sortPlayersForRound(players, tournamentId,
// roundNum);

// // Assert
// assertEquals(2, matchups.size()); // Expecting two matchups (with one pair
// skipped)

// // Validate the matchups
// assertEquals("player2-uuid", matchups.get(0).getPlayer1()); // Player with
// highest ELO
// assertEquals("player4-uuid", matchups.get(0).getPlayer2()); // Next highest
// ELO
