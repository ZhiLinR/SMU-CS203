...
// when(tournamentInfoUtil.getMatchupsByTournamentId(tournamentId)).thenReturn(new
// ArrayList<>());
...
// // Assert
// assertTrue(result.isEmpty(), "Expected no matchups to be generated for round
// 1 with no signups.");
...
// // Assert
// assertEquals(2, result.size(), "Expected 2 matchups to be created, with 1
// bye.");
// assertEquals("player3", result.get(1).getPlayer1(), "Expected the bye player
// to be player3.");
// }
...
// // Assert
// assertEquals(2, result.size(), "Expected 2 matchups to be created in round
// 2.");
// }
