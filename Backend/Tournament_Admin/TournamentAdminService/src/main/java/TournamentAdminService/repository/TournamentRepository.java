...
public interface TournamentRepository extends JpaRepository<Tournament, String> {
    ...
    void createTournament(@Param("p_startDate") Date startDate, @Param("p_endDate") Date endDate,
                          @Param("p_location") String location, @Param("p_playerLimit") int playerLimit,
                          @Param("p_isActive") boolean isActive, @Param("p_descOID") String descOID, @Param("p_name") String name);
