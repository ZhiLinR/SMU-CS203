...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    /**
     * Retrieves the hashed password for the user associated with the specified email.
     *
     * @param email the email address of the user whose hashed password is to be retrieved
     ...
     * @return the {@link User} object representing the user's profile, or null if the user does not exist
     */
     ...
     * @return a byte representing the user's role, or null if the user does not exist
     */
     ...
     * @param isAdmin a byte indicating whether the user should be an administrator (1) or not (0)
