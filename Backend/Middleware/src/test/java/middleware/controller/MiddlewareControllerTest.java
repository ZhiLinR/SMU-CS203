...
public class MiddlewareControllerTest {
        ...
        /**
         * {@link MockMvc} instance used to simulate HTTP requests and validate
         * responses.
         */
        @Autowired
        ...
        /**
         * JWT request with an invalid signature for testing signature validation
         * failure.
         */
        ...
        /**
         * Tests the {@link MiddlewareController#checkJwt(JWTRequest)} endpoint with a
         * valid JWT token.
         * <p>
         * Verifies that the response contains valid user data and returns HTTP 200
         * status.
         * </p>
         * 
         ...
         * <p>
         * Verifies that the response returns HTTP 404 status with an appropriate error
         * message.
         * </p>
         * 
         * @throws Exception if an error occurs during test execution
        ...
        /**
         * Tests the {@link MiddlewareController#checkJwt(JWTRequest)} endpoint with an
         * unauthorized access scenario.
         * <p>
         * Verifies that the response returns HTTP 401 status with an appropriate error
         * message.
         * </p>
         * 
         * @throws Exception if an error occurs during test execution
         ...
         * <p>
         * Verifies that the response returns HTTP 500 status with an appropriate error
         * message.
         * </p>
         * 
         * @throws Exception if an error occurs during test execution
